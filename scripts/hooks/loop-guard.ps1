...
Write-KgSignal -Source "loop-guard" -EntityName "hook-loop-guard-$(Get-Date -Format 'yyyyMMdd')" -EntityType "hook-execution" -Observations @("loop-guard executed at $(Get-Date -Format 'o')") -Priority "low"
